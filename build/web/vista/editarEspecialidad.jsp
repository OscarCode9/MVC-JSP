    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <body>
                            ...
                            <div class="col s12 m3 l3">
                                <div class="card grey darken-4">
                                    <div class="card-content white-text">
                                        <form action="AdminEspecialidad?action=editar" method="post">
                                            <span class="card-title">
                                                <input type="text" name="nombre" value="<c:out value=" ${especialidad.nombre} " />">
                                            </span>
                                            <p>
                                                <strong>ID: </strong>
                                                <input type="number" name="idEspecialidad" value="<c:out value="${especialidad.idEspecialidad}" />">
            ...
            <div class="fixed-action-btn horizontal click-to-toggle">
                ...
                <ul>
                    <li>
                        <a class="btn-floating red btn modal-trigger tooltipped" data-position="top" data-delay="50" data-tooltip="Agregar hospital"
                    ...
                    <li>
                        <a class="btn-floating green btn modal-trigger tooltipped" data-position="top" data-delay="50" data-tooltip="Agregar especialidad"
                            data-target="modal2" href="#modal2" data-target="modal3" href="#modal3">
