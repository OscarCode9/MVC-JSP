...
<html>
    ...
    <main>
        <div className="row row-home" style="padding-left: 200px;">
            ...
            <div class="container">
                <h4>Bienvenido al sistema para administrar hospitales</h4>

                <div class="row center">
                    <a href="AdminHospitales?action=mostrar" class="waves-effect waves-light btn-large">Hospitales</a>  
                </div>
    ...
    <div class="fixed-action-btn horizontal click-to-toggle">
        ...
        <ul>
            ...
            <li><a class="btn-floating green btn modal-trigger tooltipped" data-position="top" data-delay="50" data-tooltip="Agregar especialidad"  data-target="modal3"  href="#modal3"><i class="fas fa-user-md"></i></a></li>
        </ul>
